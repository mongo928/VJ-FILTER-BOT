...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b> 
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Master_Jiraya'>🄼𝗮𝘀𝘁𝗲𝗿 𝗝𝗶𝗿𝗮𝘆𝗮</a> 
 ‣ ʟɪʙʀᴀʀʏ : Who Care...😒 
 ‣ ʟᴀɴɢᴜᴀɢᴇ : Only Hindi 🤣
 ‣ ᴅᴀᴛᴀ ʙᴀsᴇ : Free Wala 😁 
 ‣ ʙᴏᴛ sᴇʀᴠᴇʀ : Free Wala 😁
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/Master_Jiraya>🄼𝗮𝘀𝘁𝗲𝗿 𝗝𝗶𝗿𝗮𝘆𝗮</a></b>
  
 <b>✯ Join here : <a href=https://t.me/The_Happy_Hours>Click Here</a></b> 
...
Nᴀᴍᴇ - {}"""
    ...
    OLD_ALRT_TXT = """ये मैसेज बहुत पुराना है...🥱"""

    CUDNT_FND = """मूवी का नाम गलत है...!!!"""
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)</b>"""
    ...
    I_CUD_NT = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ.
...
BOT WORKING PROPERLY"""
    ...
    TAMIL_INFO = """<a href='tg://settings'>My Friend</a>
 Exp: /set_tutorial video Link"""

    ENGLISH_INFO = """<a href='tg://settings'>My Friend</a> 
Exp: /set_tutorial video link"""

    TELUGU_INFO = """<a href='tg://settings'>My Friend</a>"""
...
এছাড়াও আপনার দল ভিডিও সংগ্রহের প্রশিক্ষণ দেবে..."""
    ...
    DEVELOPER_TXT = """<a href='https://t.me/Master_Jiraya'>🄼𝗮𝘀𝘁𝗲𝗿 𝗝𝗶𝗿𝗮𝘆𝗮</a>
"""
