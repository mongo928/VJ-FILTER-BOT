...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('filter2023.herokuapp.com')
else:
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'filter2023.herokuapp.com'
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = str(getenv('filter2023.herokuapp.com'))
